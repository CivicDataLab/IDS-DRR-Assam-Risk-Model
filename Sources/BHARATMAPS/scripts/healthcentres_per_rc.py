...
cwd = os.getcwd()
health_centres_gdf = gpd.read_file(cwd+'/Sources/BHARATMAPS/data/BharatMaps_HealthCenters.geojson')
...
health_centres_count.to_csv(cwd+'/Sources/BHARATMAPS/data/healthcentres_per_rc.csv', index=False)