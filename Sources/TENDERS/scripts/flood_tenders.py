...
input_df = pd.read_csv(os.getcwd()+'/Sources/TENDERS/data/consolidated_v2.csv')
...
idea_frm_tenders_df.to_csv(os.getcwd()+'/Sources/TENDERS/data/IDEA-FRM_filtered_tenders_with_metadata.csv',
                           encoding='utf-8')