...
total_tender_awarded_value_df= flood_tenders_geotagged_df.groupby(['month','DISTRICT_FINALISED','REVENUE_CIRCLE_FINALISED'])[['Awarded Value']].sum().reset_index()
...
for variable in variables:
    ...
    variable_df= variable_df.groupby(['month','DISTRICT_FINALISED','REVENUE_CIRCLE_FINALISED'])[['Awarded Value']].sum().reset_index()
