    ...
    for j in range(2021,2024):
        if j == 2021:
            for k in range(5,13):
                ...
                RC.append(i)
                year.append(j) 
                data_index = (data['object_id'] == i) &(data['time_stamp'] <= k-4)
                data_selected = data[data_index]
            ...
            if j == 2023:
                for k in range(1,9):
                    ...
                    year.append(j) 
                    if (k<= 3):
                        data_index = (data['object_id'] == i) & (data['time_stamp'] >= 14) & (data['time_stamp'] <= 23 - 3 + k)
                        data_selected = data[data_index]
                        cum_CIDF_tenders_awarded_value.append(data_selected['CIDF_tenders_awarded_value'].sum())
                        cum_Immediate.append(data_selected['Immediate Measures_tenders_awarded_value'].sum())
                        cum_LTIF_tenders_awarded_value.append(data_selected['LTIF_tenders_awarded_value'].sum())
                        ...
                        cum_total_tender_awarded_value.append(data_selected['total_tender_awarded_value'].sum())
                    if (k > 3):
                        data_index = (data['object_id'] == i) & (data['time_stamp'] >= 24) & (data['time_stamp'] <= 28 + k - 8)
                        data_selected = data[data_index]
                        cum_CIDF_tenders_awarded_value.append(data_selected['CIDF_tenders_awarded_value'].sum())
                        cum_Immediate.append(data_selected['Immediate Measures_tenders_awarded_value'].sum())
                        cum_LTIF_tenders_awarded_value.append(data_selected['LTIF_tenders_awarded_value'].sum())
                ...
                for k in range(1,13):
                    ...
                    year.append(j) 
                    if k <= 3:
                        data_index = (data['object_id'] == i) & (data['time_stamp'] >= 1) & (data['time_stamp'] <= 11 + k - 3)
                        data_selected = data[data_index]
                        cum_CIDF_tenders_awarded_value.append(data_selected['CIDF_tenders_awarded_value'].sum())
                        cum_Immediate.append(data_selected['Immediate Measures_tenders_awarded_value'].sum())
                        cum_LTIF_tenders_awarded_value.append(data_selected['LTIF_tenders_awarded_value'].sum())
                        ...
                        cum_total_tender_awarded_value.append(data_selected['total_tender_awarded_value'].sum())
                    if k > 3:
                        data_index = (data['object_id'] == i) & (data['time_stamp'] >= 12) & (data['time_stamp'] <= 13 + k - 3)
                        data_selected = data[data_index]
                        cum_CIDF_tenders_awarded_value.append(data_selected['CIDF_tenders_awarded_value'].sum())
                        cum_Immediate.append(data_selected['Immediate Measures_tenders_awarded_value'].sum())
                        cum_LTIF_tenders_awarded_value.append(data_selected['LTIF_tenders_awarded_value'].sum())
